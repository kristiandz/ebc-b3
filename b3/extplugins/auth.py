...
class AuthPlugin(b3.plugin.Plugin):
    ...
    def onLoadConfig(self):
        ...
        self._need_auth = self._get_setting('messages', 'auth_message', default='^7Please authenticate yourself with ^1!auth <password>')
        self._auth_done = self._get_setting('messages', 'auth_done', default='^1You have been authenticated!')
        self._already_done = self._get_setting('messages', 'already_done', default='^1You have already been authenticated!')
