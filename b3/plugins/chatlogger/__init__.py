...
class ChatloggerPlugin(Plugin):
    ...
    _hours = None
    _minutes = None
    _db_table = 'chatlog_change'
    _db_table_cmdlog = 'cmdlog_change'
    _file_name = None
    _filelogger = None
    _save2db = None
    _save2file = None
    ...
    def onStartup(self):
        ...
        if 'chatlog_change' not in current_tables or 'cmdlog_change' not in current_tables:
