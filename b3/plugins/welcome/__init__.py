...
class WelcomePlugin(b3.plugin.Plugin):
    ...
    _default_messages = {
        'first': '^7Welcome $name^7, this must be your first visit, you are player ^1#$id. Type !help for help',
        'newb': '^7[^1Authed^7] Welcome back $name ^7[^1@$id^7], last visit ^1$lastVisit. '
                'Type !register in chat to register. Type !help for help',
        'user': '^7[^1Authed^7] Welcome back $name ^7[^1@$id^7], last visit ^1$lastVisit^7, '
                'you\'re a ^1$group^7, played $connections times',
        'announce_first': '^7Everyone welcome $name^7, player number ^1#$id^7, to the server',
        'announce_user': '^7Everyone welcome back $name^7, player number ^1#$id^7, to the server, '
